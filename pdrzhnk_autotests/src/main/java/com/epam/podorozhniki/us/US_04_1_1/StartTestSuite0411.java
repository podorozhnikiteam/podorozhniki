 ...
 */
public class StartTestSuite0411 extends JUnitStories{

    @Override
    public Configuration configuration() {
        Class<? extends StartTestSuite0411> embeddableClass = this.getClass();
    ...
    public List<CandidateSteps> candidateSteps() {
        try {
            return new InstanceStepsFactory(configuration(), new usRunner0411()).createCandidateSteps();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
